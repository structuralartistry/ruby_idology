    ...
    class Response
      ...
      def initialize(raw_xml)
        ...
        if ! (self.parsed_response/:error).empty?
          ...
          # the ID to be used in further RubyIdology calls
          ...
          self.result_key = "error"
          self.result_message = "RubyIdology returned an unexpected error."
    ...
    class VerificationResponse < Response
      ...
      def initialize(raw_xml)
        ...
        if ! (self.parsed_response/"idliveq-error").empty?
          ...
          self.idliveq_result_message = "RubyIdology returned an unexpected error."
      ...
      def challenge?
        # the logic for challenge questions is not relayed via RubyIdology, so we must set the logic here
    ...
    class ChallengeVerificationResponse < Response
      ...
      def initialize(raw_xml)
        ...
        if ! (self.parsed_response/"idliveq-challenge-error").empty?
          ...
          self.idliveq_challenge_result_message = "RubyIdology returned an unexpected error."
