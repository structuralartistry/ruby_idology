...
describe Response do
  ...
  it "should check for an error from RubyIdology" do
  ...
  it "should return an error message if RubyIdology response is not understood" do
    response = Response.new(mock_unknown_response)
    response.result_key.should eql("error")
    response.result_message.should eql("RubyIdology returned an unexpected error.")
  end
